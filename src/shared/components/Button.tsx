...
const Button = ({ title, onClick, icon, className = 'bg-gray-800 hover:bg-gray-700' }: ButtonProps) => {
  return (
    <button onClick={onClick} className={`flex item-center gap-4 px-6 py-2 rounded-lg transition overflow-hidden shadow shadow-gray-900 cursor-pointer ${className}`} title={title}>
